...
Демо снимките на автомобилите са реални фотографии на съответните модели от **Wikimedia
Commons / Wikipedia**, използвани под техните свободни лицензии (CC) единствено за
демонстрационни цели в този учебен проект. В реална употреба всеки продавач качва свои снимки.
